...
<head>
    ...
    <link rel="shortcut icon" href="{% static 'img/FaviconUmpLogo.ico' %}" type="image/x-icon">
    <link rel="icon" href="{% static 'img/FaviconUmplogo-32x32.png' %}" sizes="32x32" type="image/png">
    <link rel="icon" href="{% static 'img/FaviconUmplogo-16x16.png' %}" sizes="16x16" type="image/png">
